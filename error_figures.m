...
analytical_result_x = PDE_x_analytical_function(X, Y, 22.7 * 10^9, 42.3 * 10^9); % x, y, lambda, mu
analytical_result_y = PDE_y_analytical_function(X, Y, 22.7 * 10^9, 42.3 * 10^9);
